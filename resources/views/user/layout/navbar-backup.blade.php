      ...
      <div class="flex items-center px-4">
        ...
        >
          <ul class="block lg:flex menu">
            ...
            <li class="group"> 
              <a href="#" class="text-base text-dark py-2 mx-8 flex group-hover:text-color1 group-hover:font-semibold">
              ...
              <li class="group">
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                  <button @click="open = !open" class="flex flex-row items-center w-full px-4 py-2 mt-2 text-left bg-transparent rounded-lg md:w-auto md:inline md:mt-0 md:ml-4 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                    <span class="group-hover:text-color1 group-hover:font-semibold">Action</span>
            ...
            @else 
              ...
              <li class="group">
                <form method="POST" action="{{ route('logout') }}">
                  ...
                  this.closest('form').submit();" class="text-base text-dark py-2 mx-8 flex group-hover:text-color1 group-hover:font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
